require(['jquery-noconflict', 'bootstrap-tooltip'], function(jQuery) {
  ...
  $(function() {   
    ...
    $("input[value='tweet1']").on("click", function() {
      ...
      $("#tweet1-box .panel-heading h2").html("This article is <strong>MORE</strong> credible");
      $("#tweet2-box").removeClass().addClass("panel panel-danger");
      $("#tweet2-box .panel-heading h2").html("This article is <strong>LESS</strong> credible");  
      $(".morecredible").val(1);
      $(".lesscredible").val(0);
      $(".same").val(0);
    });
    ...
    $("input[value='tweet2']").on("click", function() {
      ...
      $("#tweet1-box .panel-heading h2").html("This article is <strong>LESS</strong> credible"); 
      $("#tweet2-box").removeClass().addClass("panel panel-success");
      $("#tweet2-box .panel-heading h2").html("This article is <strong>MORE</strong> credible"); 
      $(".morecredible").val(0);
      $(".lesscredible").val(1);
      $(".same").val(0);
    });
    ...
    $("input[value='same']").on("click", function() {
      ...
      $("#tweet1-box .panel-heading h2").html("Both articles are <strong>EQUALLY</strong> credible"); 
      $("#tweet2-box").removeClass().addClass("panel panel-default");
      $("#tweet2-box .panel-heading h2").html("Both articles are <strong>EQUALLY</strong> credible");
      $(".morecredible").val(0);
      $(".lesscredible").val(0);
      $(".same").val(1);
    });
