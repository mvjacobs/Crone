    ...
    def get_mutual_info(self):
        ...
        for ann1 in ann_keys:
            ...
            for ann2 in ann_keys:
                ...
                term_0_0 = 0 if p_0_0 == 0.0 or prob_ann1 == 1.0 or prob_ann2 == 1.0 else p_0_0 * log(
                    p_0_0 / ((1 - prob_ann1) * (1 - prob_ann2)))
                term_0_1 = 0 if p_0_1 == 0.0 or prob_ann1 == 1.0 or prob_ann2 == 0.0 else p_0_1 * log(
                    p_0_1 / ((1 - prob_ann1) * prob_ann2))
                term_1_0 = 0 if p_1_0 == 0.0 or prob_ann1 == 0.0 or prob_ann2 == 1.0 else p_1_0 * log(
                    p_1_0 / (prob_ann1 * (1 - prob_ann2)))
                term_1_1 = 0 if p_1_1 == 0.0 or prob_ann1 == 0.0 or prob_ann2 == 0.0 else p_1_1 * log(
                    p_1_1 / (prob_ann1 * prob_ann2))
